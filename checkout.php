...
if (empty($_SESSION["user_id"])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        foreach ($_SESSION["cart_item"] as $item) {
            ...
            $SQL = "INSERT INTO users_orders (u_id, title, quantity, price, instruction) 
                        VALUES ('$user_id', '" . $item["title"] . "', '" . $item["quantity"] . "', '" . $item["price"] . "', '" . $_POST["instruction"] . "')";

            mysqli_query($db, $SQL);
        }

        // Your existing code for inserting into payments table
        // ...

        $success = "Thank you! Your Order Placed successfully! You will be redirected to your order.";
...
$item_total ; // Assuming the shipping fee is 40 Rs
                    ...
                    <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> <?php echo $item_total += 40?></strong></td>
                                                    </tr>
                                                </tbody>
                           ...
                           <h3><strong>Instruction</strong></h3>
							  <form action="" method="post">
                                 ...
                                 <div class="form-group col-sm-12">
                                    <textarea class="form-control" id="exampleTextarea" name="instruction" placeholder="Instruction" rows="3" required></textarea>
                                </div>
                                        ...
                                        <ul class=" list-unstyled">
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" id="radioStacked1"  value="COD" type="radio" class="custom-control-input" required> <span class="custom-control-indicator"></span> <span class="custom-control-description"><img src="images/takeaway.png" alt="" width="25" />Take Away</span>
                                                   </label>
                                            </li>
                                            <li>
