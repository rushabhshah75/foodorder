...
$sql = "SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.u_id = users_orders.u_id WHERE users_orders.status='delivered'";
...
<head>
    ...
    <title>Delivered Orders History</title>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h1><span style="color:Green;">Delivered Orders History</span></h1>
                    ...
                    <table id="ordersTable" class="table" bgcolor="green" >
                        <thead>
                            <tr>
